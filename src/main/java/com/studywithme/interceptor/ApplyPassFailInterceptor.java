...
public class ApplyPassFailInterceptor extends HandlerInterceptorAdapter {
	
	private static final Logger logger = LoggerFactory.getLogger(ApplyPassFailInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, 
		...
		logger.info("ApplyPassFail preHandle 실행");
		...
		if (userId.equals(applyAccessVO.getStudyWriter())) {
			// 스터디 작성자(그룹장) 지원서 합격 접근 가능
			return true;
		}
